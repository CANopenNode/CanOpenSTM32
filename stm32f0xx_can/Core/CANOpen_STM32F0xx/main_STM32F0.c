...
#include "../CANOpen_STM32F0xx/CO_storageBlank.h"
#include "../CANOpen_STM32F0xx/OD.h"
#include "tim.h"
#include "can.h"
...
int main_canopen (void){
    ...
    CANptr = &hcan;
    uint8_t pendingNodeId = 12; /* read from dip switches or nonvolatile memory, configurable by LSS slave */
    uint8_t activeNodeId = 12; /* Copied from CO_pendingNodeId in the communication reset section */
