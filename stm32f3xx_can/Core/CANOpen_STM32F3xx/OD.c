/*******************************************************************************
    ...
    This file was automatically generated by CANopenEditor v4.0-57-gbfbc671-dirty
...
OD_ATTR_PERSIST_COMM OD_PERSIST_COMM_t OD_PERSIST_COMM = {
    ...
    .x6000_handpieceCounter = 0x00000000
};
...
typedef struct {
    ...
    OD_obj_var_t o_6000_handpieceCounter;
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_handpieceCounter = {
        .dataOrig = &OD_PERSIST_COMM.x6000_handpieceCounter,
        .attribute = ODA_TRPDO | ODA_MB,
        .dataLength = 4
    }
};
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x01, ODT_VAR, &ODObjs.o_6000_handpieceCounter, NULL},
