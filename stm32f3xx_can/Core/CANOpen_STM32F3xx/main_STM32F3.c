...
int main_canopen (void){
    ...
    CANptr = &hcan;
    uint8_t pendingNodeId = 8; /* read from dip switches or nonvolatile memory, configurable by LSS slave */
    uint8_t activeNodeId = 8; /* Copied from CO_pendingNodeId in the communication reset section */
